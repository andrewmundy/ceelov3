    ...
    render(){
        ...
        return ( 
            ...
            >
                ...
                <input disabled={!this.props.isLoggedIn} name="name" type="text" value={details.name} onChange={this.handleChange}></input>
                <div className="score">
                    <img alt={details.name} src={require(`../images/dice${details.score}.png`)}/>
                </div>
            </div>
        )
    }
